 ...
 * The Electron shell reuses this carrier rather than replacing it: it runs the
 * same host as a child process and loads the loopback URL in its window. This
 * package never prints: the URL line belongs to the shell.
 */
